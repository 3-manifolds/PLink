...
project = u'PLink'
copyright = u'2009-present, Marc Culler, Nathan Dunfield, Matthias Görner and others'
...
latex_documents = [
  ('index', 'PLink.tex', u'PLink Documentation',
   u'Marc Culler, Nathan Dunfield, Matthias Görner and others',
   'manual'),
]
